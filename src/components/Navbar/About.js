  ...
  return (
    <>
      ...
      <div className="left-main">
        ...
        <p class="centered" >Making money with Google Adsense - Turning Content into Cash </p>       
      </div>


      <div className="firstbody">
          <h2 className="bodytext">AdSense</h2>
        ...
        <div className="footertext">
          ...
          <div className='connectingicons'>
            ...
            <div className='connectingiconssymbol'>
              ...
              <img className = "secondicon"src={second} alt="icon"/>
              <img className = "threeicon"src={third} alt="icon"/>
              <img className = "fourthicon"src={fourth} alt="icon"/>
              <img className = "fiveicon" src={fifty} alt="icon"/>
