    ...
    return (
        <>
          ...
          <div className="left-main">
            ...
            <p class="centered" >Social Media Marketing Management - Connect & Engage to Grow your Site </p>       
          </div>
          ...
          <div className="firstbody">
              ...
              <p className='thirdp'>The benefits of working with Facebook, Twitter, and other similar sites are that it allows your business to connect with customers in ‘real time’.  If Ford used Facebook to launch its latest car, you can use it to make special offers, limited-time specials or announce last-minute changes in availability.</p>
              <p className='fourthp'>If you’ve never managed an email campaign before, don’t worry. We will give you full training and advice on how to construct the most effective message for all email programmes –  We can also keep our graphic designers busy by posting 3D demonstrations of your products on YouTube, or embed widgets into your website to encourage visitors to join your network.</p>
              <p className='fifthp'>Not convinced about social media? Join us on our Facebook page and see how we make it work for ourselves. You can also read this article, written by Inspire’s David Dwyer for Johnston Carmichael CA, Scotland’s largest Independent Chartered Accountants, on Harnessing Social Media.</p>
